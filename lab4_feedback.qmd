...
Yes! Specifically, because the N (normality) and E (equal variance) conditions are not violated, the t-distribution is a reasonable tool for approximating the sampling distribution under the null. 
